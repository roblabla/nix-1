...
struct SourceAccessor
{
     ...
     * by default wants to manipulate symlinks not use them. Using the
     * targets of symlinks should only occasionally be down, and only
     * with care.
     */
    ...
    /**
     * @note Like the `readFile`, this method should *not* follow
     * symlinks.
     */
